...
export class Order {
  ...
  public static initializeStatus(order: IOrderSummary | IOrder) {
    ...
    switch (order.order_status) {
      case 'DRAFT':
        result = {
          text: Constants.ORDER_STATUS.DRAFT,
          iconName: 'info',
          color: '#bbb'
        };
        break;
      case 'PENDING':
        result = {
          text: Constants.ORDER_STATUS.PENDING,
          iconName: 'calculate',
          color: '#7593f0'
        };
        break;
      case 'QUOTE_DONE':
        result = {
          text: Constants.ORDER_STATUS.QUOTE_DONE,
      ...
      case 'READY':
        result = {
          text: Constants.ORDER_STATUS.READY,
          iconName: 'info',
          color: '#7593f0'
        };
        break;
      case 'IN_EXTRACT':
        result = {
          text: Constants.ORDER_STATUS.IN_EXTRACT,
      ...
      case 'PARTIALLY_DELIVERED':
        result = {
          text: Constants.ORDER_STATUS.PARTIALLY_DELIVERED,
      ...
      case 'PROCESSED':
        result = {
          text: Constants.ORDER_STATUS.PROCESSED,
          iconName: 'check_outline',
          color: '#2bae66'
        };
        break;
      case 'ARCHIVED':
        result = {
          text: Constants.ORDER_STATUS.ARCHIVED,
          iconName: 'archive',
          color: '#000000'
        };
        break;
      ...
      default:
        result = {
          text: Constants.ORDER_STATUS.UNKNOWN,
          iconName: 'info',
          color: '#E993B0'
        };
        break;
